...
const LeadDetailModal = ({ lead, isOpen, onClose, onUpdate }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 animate-in fade-in duration-200">
      <div className="w-full max-w-2xl overflow-hidden rounded-lg bg-white shadow-xl animate-in zoom-in-95 slide-in-from-bottom-4 duration-200">
        {/* Header */}
            ...
            <div className="border-t border-gray-200 pt-6">
              <div className="grid gap-3 sm:grid-cols-2">
                <button
                  ...
                  className="flex items-center justify-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={isSaving || isDeleting}
                  className="flex items-center justify-center gap-2 rounded-md border border-red-300 bg-white px-4 py-2 text-sm font-medium text-red-700 hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
