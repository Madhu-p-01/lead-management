            ...
            <>
              ...
              {onBulkImportClick && (
                <button
                  ...
                  className="btn inline-flex w-full items-center justify-center gap-2 rounded-lg border border-purple-300 bg-purple-50 px-4 py-2.5 text-sm font-semibold text-purple-700 shadow-sm transition-all duration-200 hover:bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 active:scale-95"
                >
                  <svg
                    className="h-4 w-4"
                    fill="none"
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l-3-3m0 0l3-3m-3 3h12"
                    />
                  </svg>
                  Bulk CSV
                </button>
